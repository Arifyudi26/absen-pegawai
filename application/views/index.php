...
<body>
    <nav class="navbar navbar-expand-lg navbar-light navbar-floating">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img style="border-radius:100%;" src="<?= base_url('assets/img/climber.jpeg') ?>" alt="" width="120">
            </a>
                ...
                <ul class="navbar-nav ml-lg-5 mt-3 mt-lg-0">
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item active" href="<?= base_url('dashboard1') ?>">Dashboard Admin</a>
                            <a class="dropdown-item" href="<?= base_url('dashboard2') ?>">Dashboard Member</a>
                        </div>
                    </li>
                    <li class="nav-item">
    ...
    <div class="page-hero-section bg-image hero-home-1"
        style="background-image: url(<?= base_url('assets/img/bg_hero_1.svg)') ?>;">
                ...
                <div class="row align-items-center h-100">
                    <div class="col-lg-6 wow fadeInUp">
                        <div class="badge mb-2">
                            ...
                            </span> Web E-Commers App of 2021
                        </div>
                        <h1 class="mb-4">Welcome To Admin PT. Climber Style</h1>
                        <p class="mb-4">Climber Style has features to view, shop and manage <br>Like Seeing Attendance
                            Data.</p>
                    </div>
                    <div class="col-lg-6 d-none d-lg-block wow zoomIn">
                        <div class="img-place mobile-preview shadow floating-animate">
                            <img src="<?= base_url('assets/png/kisspng-hiking-computer-icons-clip-art-mountain-climber-5b2a5689b56ba8.8182625315295013217431.png') ?>"
                                alt="">
                        </div>
                    </div>
                </div>
    ...
    <div class="position-realive bg-image"
        style="background-image: url(<?= base_url('assets/png/kisspng-globe-compass-rose-clip-art-compass-5ab62103d91474.7518007215218854438892.png') ?>);">
        <div class="page-section">
            <d class="container">
                <div class="row">
                    <div class="col-lg-5 py-3">
                        <div class="img-place mobile-preview shadow wow zoomIn">
                            <img src="<?= base_url('assets/png/kisspng-backpacking-hiking-ozark-trail-blu-duby-north-5b06603372cc17.4990398415271444994702.png') ?>"
                                alt="">
                        </div>
                    </div>
                        ...
                        <div class="iconic-list">
                            <div class="iconic-item wow fadeInUp">
                                ...
                                <div class="iconic-content">
                                    ...
                                    <p class="fs-small">Easy-to-navigate product catalog Web stores can be much more
                                        than just an online product catalog – but you have to get the foundation right.
                                        Fortunately, Climber Style Commerce makes this better than others.
                                    </p>
                                </div>
                            </div>
                            <div class="iconic-item wow fadeInUp">
                                ...
                                <div class="iconic-content">
                                    <h5>Fully Secured</h5>
                                    <p class="fs-small">Confidentiality − Information should not be accessible to an
                                        unauthorized person. It should not be intercepted during the transmission. <br>
                                        Integrity − Information should not be altered during its transmission over
                                        the
                                        <br> network. Availability − Information should be available wherever and
                                        whenever required within a time limit specified.<br> Authenticity − There should
                                        be a mechanism to authenticate a user before giving him/her
                                        an access to the required information.<br> Non-Repudiability − It is the
                                        protection against the denial of order or denial of payment. Once a sender sends
                                        a message, the sender should not be able to deny sending
                                        the message. Similarly, the recipient of message should not be able to deny the
                                        receipt.<br> Encryption − Information should be encrypted and decrypted only by
                                        an authorized user.<br> Auditability − Data should
                            ...
                            <div class="iconic-item wow fadeInUp">
                                ...
                                <div class="iconic-content">
                                    ...
                                    <p class="fs-small">1. Check Your Conversion Rate<br>2. Reduce Cart
                                        Abandonment<br>3. Look at Your Site Traffic<br>4. Improve goods retention<br>5.
                                        Get the Right Platform</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-1 py-3 mt-lg-5 wow fadeInUp">
                        <h1 class="mb-4">Businesses operate effortlessly</h1>
                    </div>
                    <div class="col-lg-5 py-3">
                        <div class="img-place mobile-preview shadow wow zoomIn">
                            <img src="<?= base_url('assets/png/kisspng-backpack-mountaineering-bag-lowe-alpine-climbing-alpinist-5b36876a5711b9.6293707915303002663566.png') ?>"
                                alt="">
                        </div>
                    </div>
                </div>
    ...
    <div class="page-section bg-dark fg-white">
        <div class="container">
            <h1 class="text-center">Why Choose Climber Style</h1>
            <div class="row justify-content-center mt-5">
                <div class="col-md-6 col-lg-3 py-3">
                    <div class="card card-body border-0 bg-transparent text-center wow zoomIn">
                        <div class="mb-3">
                            <img src="<?= base_url('assets/img/icons/rocket.svg') ?>" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 py-3">
                    <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="200ms">
                        <div class="mb-3">
                            <img src="<?= base_url('assets/img/icons/testimony.svg') ?>" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 py-3">
                    <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="400ms">
                        <div class="mb-3">
                            <img src="<?= base_url('assets/img/icons/promotion.svg') ?>" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 py-3">
                    <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="600ms">
                        <div class="mb-3">
                            <img src="<?= base_url('assets/img/icons/coins.svg') ?>" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 py-3">
                    <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="800ms">
                        <div class="mb-3">
                            <img src="<?= base_url('assets/img/icons/support.svg') ?>" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 py-3">
                    <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="1000ms">
                        <div class="mb-3">
                            <img src="<?= base_url('assets/img/icons/laptop.svg') ?>" alt="">
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0 wow fadeInUp">
                    <h1 class="mb-4">PT. Climber Style </h1>
                    <p class="mb-5">Lis one of the companies engaged in the sale of equipment and clothing. The bigger
                        the company, the more human resources (HR) needed. Based on this, a company is required to carry
                        out HR management, namely an effort to manage HR more competently according to their expertise
                        so that the company's performance is more effective and efficient.</p>
    ...
    <div class="page-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 py-3">
                    <h1 class="wow fadeInUp">Need a help? <br> Don't worry just contact us</h1>
            ...
            <div class="row mb-5 py-3">
                ...
                <div class="col-md-6 col-lg-4 py-3">
                    ...
                    <ul class="menu-link">
                        ...
                        <li><a href="#" class="">climberstyle@mobster.com</a></li>
                        <li><a href="#" class="">support@mobster.com</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 py-2">
                    ...
                    <p class="d-inline-block ml-2">Copyright &copy; <a href="#" class="fg-white fw-medium">Mobster</a>.
